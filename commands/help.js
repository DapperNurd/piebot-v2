...
const miscCommands = ["!help, !commands", "!stats, !info", "!global", "!server, !guild", "!ask (question)", "!gif (search term)","!scale (max) (question)", "!odds, !chances (question)", "!coinflip, !cf", "!roll (max)", "!ping" ];
